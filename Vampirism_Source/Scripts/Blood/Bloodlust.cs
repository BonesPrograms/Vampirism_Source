...
namespace XRL.World.Effects
{
    ...
    public class Bloodlust : Effect
    {
        ...
        public override string GetDetails() => Gameover ? "I need more." : Details();
        public override string GetDescription() => Gameover ? "{{R|bloodlusted}}" : Description();
        string Description() => base.Object.GetStringProperty(Flags.BLOOD_STATUS) == Flags.Blood.MIN ? "{{R sequence|ravenous}}" : "{{R sequence|thirsty}}";
        string Details()
         =>
            base.Object.GetStringProperty(Flags.BLOOD_STATUS) switch
            {
        ...
        {
            if (!Scan.SafeReturnProperty(base.Object, Flags.FRENZY))
        ...
        {
            AutoAct.Interrupt();
            if (!Scan.SafeReturnProperty(Object, Flags.FRENZY))
