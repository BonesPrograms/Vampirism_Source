...
namespace VampirismSys.Stealth
{
    ...
    public class Alert
    {
        ...
        public void RemoveEffectFromWitness<T>(uint radius = Rules.Stealth.AI_RADIUS) where T : Effect
        {
        ...
        // void publicAddEffect<T>(T obj, uint AoE) where T : Effect, new()
        // {
        //     AoE = this.AoE(AoE);
