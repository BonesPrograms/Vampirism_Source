...
namespace XRL.World.Effects
{
	...
	public class CombatFeed : IFeeding
	{
		...
		public CombatFeed(GameObject other, bool isAttacker, int Level, string DamagePerRound, int Duration, bool Frenzy, bool Friendly) : base(other, isAttacker, Level, DamagePerRound, Duration)
		{
			this.Frenzy = Frenzy;
		...
		void ScaryMonster()
		{
			if (!Friendly && !other.Object.MakeSave("Toughness", 13, null, null, "Scary Vampire Attack"))
