...
namespace Nexus.Core
{
    ...
    // }
    interface ICopyEffect<T> where T : Effect, new()
    {
        public T Copy(T e);
    }
    ...
    abstract class CopyEffect
    {
        ...
        static bool Checksupport<T>(T obj) where T : Effect, new()
        {
            if (obj is null)
        ...
        public static bool TryCopy<T>(T Effect, out T obj) where T : Effect, new()// recommended to use this one because it has fail state notifications
        {
            obj = null;
        ...
        public static T Copy<T>(T Effect) where T : Effect, new() //supports many but not all basegame effects and mod effects that implement ICopyEffect<T>
         =>
             Effect switch
             {
                 ICopyEffect<T> e => Copy<T>(e),
        ...
        public static T Copy<T>(ICopyEffect<T> e) where T : Effect, new()
        {
            return e.Copy((T)e);
        }
